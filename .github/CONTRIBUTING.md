Contributing to dependent-dropdown
==================================
Looking to contribute something to dependent-dropdown? **Here's how you can help.**
...
[plugin documentation](http://plugins.krajee.com/dependent-dropdown), 
[plugin demos](http://plugins.krajee.com/dependent-dropdown/demo), and / or refer to the
[webtips Q & A forum](http://webtips.krajee.com/questions) which are the better places to get help.

Reporting bugs with dependent-dropdown
---------------------------------------
We really appreciate clear bug reports that _consistently_ show an issue
_within dependent-dropdown_.
...
- What version of jQuery are you using? And what version of dependent-dropdown?
- Are you using dependent-dropdown with other plugins?

All of these questions will help others fix and identify any potential bugs.

Requesting features in dependent-dropdown
-----------------------------------------
Before starting work on a major feature for dependent-dropdown, **read the
[documentation](http://plugins.krajee.com/dependent-dropdown)  first** or you may risk spending a considerable amount of
...
dependent-dropdown regularly receives new issues which need to be tested and organized.
...
If you can test issues that are reported to dependent-dropdown that contain test cases and
...
It should also be made clear that **all code contributed to dependent-dropdown** must be
licensable under the [BSD-3 license][licensing].  Code that cannot be released
under this license **cannot be accepted** into the project.

[isolated-case]: https://jsfiddle.net/
[issue-search]: https://github.com/kartik-v/dependent-dropdown/search?q=&type=Issues
[issue-tracker]: https://github.com/kartik-v/dependent-dropdown/issues
[licensing]: https://github.com/kartik-v/dependent-dropdown/blob/master/LICENSE.md
[reporting-bugs]: #reporting-bugs-with-dependent-dropdown
[requesting-features]: #requesting-features-in-dependent-dropdown